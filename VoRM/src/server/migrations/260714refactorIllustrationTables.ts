...
export const up = async ({ context: queryInterface }: { context: QueryInterface }) => {
  ...
  await queryInterface.addColumn('illustrations', 'name', {
    type: DataTypes.STRING,
    allowNull: false,
    defaultValue: 'Untitled'
  })

  await queryInterface.addColumn('illustrations', 'description', {
    type: DataTypes.TEXT,
    allowNull: true
  })

  await queryInterface.addColumn('illustrations', 'graphcode', {
...
export const down = async ({ context: queryInterface }: { context: QueryInterface }) => {
  await queryInterface.removeColumn('illustrations', 'graphcode')
  await queryInterface.removeColumn('illustrations', 'description')
  await queryInterface.removeColumn('illustrations', 'name')
